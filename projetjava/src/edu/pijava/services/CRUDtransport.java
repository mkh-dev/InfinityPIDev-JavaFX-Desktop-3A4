...
public class CRUDtransport /*implements InterfaceServices*/ {
    ...
    public void ajoutertransport(Transport t) {
        try {
            ...
            String req = "Insert into transport values(0,'" + t.getType_transport() + "','" + t.getDate_depart() + "','" + t.getHeure_depart() + "','" + t.getLieu_depart() + "','" + t.getLieu_arriver() + "','" + t.getPrix_transport() + "','" + t.getText_color()+ "','" + t.getBack_color()+ "','" + t.getBorder_color()+ "')";
    ...
    public void modifiertransport(Transport t) {
        try {
            String req = "UPDATE `transport` SET `Id_transport` = '" + t.getId_transport() + "', `Heure_depart` = '" + t.getHeure_depart() + "',`Date_depart` = '" + t.getDate_depart() + "',`Type_transport` = '" + t.getType_transport() + "',`Lieu_depart` = '" + t.getLieu_depart() + "',`Lieu_arriver` = '" + t.getLieu_arriver() + "',`Prix_transport` = '" + t.getPrix_transport() + "',`text_color` = '" + t.getText_color()+ "',`back_color` = '" +  t.getBack_color()+ "',`border_color` = '" +  t.getBorder_color()+ "' WHERE `transport`.`Id_transport` = " + t.getId_transport();
    ...
    public List<Transport> affichertransport() {
        ...
        try {
            ...
            while (result.next()) {
                Transport resultatTransport = new Transport(result.getInt("Id_transport"), result.getString("heure_depart"), result.getString("date_depart"), result.getString("type_transport"), result.getString("lieu_depart"), result.getString("lieu_arriver"), result.getFloat("prix_transport"),result.getString("text_color"),result.getString("back_color"),result.getString("border_color"));
    ...
    public HashMap<String, Integer> getSTatsTypeTrans() {
        ...
        try {
            ...
            /*while (result.next()) {
                Transport1 resultatTransport = new Transport1(result.getInt("Id_transport"), result.getString("heure_depart"), result.getString("date_depart"), result.getString("type_transport"), result.getString("lieu_depart"), result.getString("lieu_arriver"), result.getFloat("prix_transport"));
                trans.add(resultatTransport);
            }*/
            //System.out.println(trans);
